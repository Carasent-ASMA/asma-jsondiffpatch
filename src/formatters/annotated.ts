...
class AnnotatedFormatter extends BaseFormatter<AnnotatedFormatterContext> {
    ...
    typeFormattterErrorFormatter(context: AnnotatedFormatterContext, err: unknown) {
    ...
    rootBegin(context: AnnotatedFormatterContext, type: DeltaType, nodeType: NodeType) {
    ...
    format_node(context: AnnotatedFormatterContext, delta: ObjectDelta | ArrayDelta, left: unknown) {
        // recurse
...
const formatAnyChange = function <TDeltaType extends keyof DeltaTypeAnnotationsMap>(
